...
impl Processor {
    ...
    fn process_init_escrow(
        ...
        let accounts_info_iter = &mut  accounts.into_iter();
        ...
        let temp_token_account = next_account_info(accounts_info_iter)?;

        let token_to_receive_account = next_account_info(accounts_info_iter)?;
